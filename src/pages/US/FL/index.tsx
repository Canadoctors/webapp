...
export const metadata: Metadata = {
  ...
  description: 'Get your Medical ID Cannabis in Florida with CanaDoctors. Expert guidance, fast approvals, and compassionate care. Start your journey to wellness today.',
  openGraph: {
    title: 'Medical ID Cannabis in Florida | CanaDoctors',
    description: 'Get your Medical ID Cannabis in Florida with CanaDoctors. Expert guidance, fast approvals, and compassionate care.',
        ...
        <main className="flex-1">
                ...
                <Parallax translateY={[-20, 20]}>
                  <div className="flex flex-col items-start space-y-4 pb-32">
                    ...
                    <p className="text-lg text-gray-300 max-w-[600px]">
                      Get your Florida Medical Cannabis Card with expert guidance. Professional care, fast approvals, and compassionate support throughout your journey.
                    </p>
          ...
          <section id="benefits" className="py-12 md:py-24 lg:py-32">
            <div className="container mx-auto px-4 lg:px-8 xl:px-12 max-w-7xl">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-8 text-center">Benefits of Medical Cannabis in Florida</h2>
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {[
                  { title: "Chronic Pain Relief", description: "Effective management for various chronic pain conditions." },
                  { title: "PTSD Treatment", description: "Helps manage symptoms of post-traumatic stress disorder." },
                  { title: "Cancer Symptom Management", description: "Aids in managing symptoms and side effects of cancer treatments." },
                  { title: "Epilepsy Control", description: "Assists in reducing seizures for some forms of epilepsy." },
                  { title: "Glaucoma Treatment", description: "May help in reducing intraocular pressure in glaucoma patients." },
                  { title: "Multiple Sclerosis Support", description: "Helps manage symptoms like muscle spasms in MS patients." },
                ].map((benefit, index) => (
          ...
          <section id="process" className="py-12 md:py-24 lg:py-32 bg-gray-50">
            <div className="container mx-auto px-4 lg:px-8 xl:px-12 max-w-7xl">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-8 text-center">How to Get Your Medical Cannabis ID in Florida</h2>
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                {[
                  { step: 1, title: "Qualify", description: "Ensure you have a qualifying condition as per Florida law." },
                  { step: 2, title: "Doctor Consultation", description: "Schedule an appointment with a certified Florida marijuana doctor." },
                  { step: 3, title: "Register with the State", description: "Complete your registration with the Florida Medical Marijuana Use Registry." },
                  { step: 4, title: "Receive Card", description: "Wait for your medical marijuana card to arrive and visit a dispensary." },
                ].map((step, index) => (
          ...
          <section id="services" className="py-12 md:py-24 lg:py-32">
            <div className="container mx-auto px-4 lg:px-8 xl:px-12 max-w-7xl">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-8 text-center">Our Services in Florida</h2>
              <div className="grid gap-6 md:grid-cols-2">
                {[
                  { title: "In-Person Consultations", description: "Comprehensive in-person appointments with licensed Florida physicians specializing in medical cannabis." },
                  { title: "Application Assistance", description: "Expert guidance through the Florida Medical Cannabis Registry application process." },
                  { title: "Follow-up Care", description: "Ongoing support and follow-up consultations to ensure optimal treatment outcomes." },
                  { title: "Educational Resources", description: "Access to comprehensive educational materials about medical cannabis use and Florida regulations." },
                ].map((service, index) => (
              ...
              <Accordion type="single" collapsible className="w-full max-w-3xl mx-auto">
                {[
                  { 
                    ...
                    answer: "Patients with qualifying conditions such as: Cancer, Epilepsy, Glaucoma, HIV/AIDS, PTSD, ALS, Crohn's disease, Parkinson's disease, Multiple sclerosis, Medical conditions of the same kind or class as or comparable to those above, Terminal conditions, Chronic nonmalignant pain caused by a qualifying medical condition."
                  },
                  ...
                  { question: "Are in-person consultations required?", answer: "Yes, Florida requires in-person consultations for medical cannabis certifications." },
                  { question: "How much does it cost to get a medical cannabis card in Florida?", answer: "The cost includes the state application fee and the physician consultation fee. Contact us for current pricing information." },
                  { question: "How long is the medical cannabis card valid in Florida?", answer: "Medical cannabis cards in Florida are typically valid for one year in Florida." },
                ].map((faq, index) => (
