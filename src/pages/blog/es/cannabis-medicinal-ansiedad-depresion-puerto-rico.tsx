          ...
          <div className="space-y-6">
            <Card className="overflow-hidden">
              <div className="aspect-video relative lg:aspect-[2/1]">
                <Image src="/images/blog/cannabis-ansiedad-depresion-pr.png" alt="Cannabis medicinal para ansiedad y depresión en Puerto Rico" fill className="object-cover" priority />
              </div>
